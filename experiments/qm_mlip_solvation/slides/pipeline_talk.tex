...
\begin{frame}{Result: automatic routing halves the error}
  ...
  \\[0.2em]
  {\footnotesize Matched subset, 101 reactions processed so far. \emph{huge/floppy} $45\to12$, \emph{anion} $47\to22$;
  \emph{isomerase} unchanged (correctly gated).}
\end{frame}
  ...
  \begin{columns}[T]
    \begin{column}{0.62\textwidth}
      \begin{itemize}
        ...
        \item Matched-subset MAE \textbf{25 \arw{} 13\kj}; \emph{huge/floppy} \textbf{45 \arw{} 12}.
