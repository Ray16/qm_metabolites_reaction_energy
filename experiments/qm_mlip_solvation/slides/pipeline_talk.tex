...
\begin{frame}[plain]
  \vspace{-0.5em}
  \begin{center}
  {\color{brandblue}\bfseries\large Head-to-head where group-contribution struggles}\\[0.1em]
  \includegraphics[width=\textwidth,height=0.86\textheight,keepaspectratio]{deck_top10_comparison.png}
  \end{center}
\end{frame}
